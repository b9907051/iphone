...
csv_file.close()
country_list = ['US','JP','IT','ES','CA','DE','GB','FR','BR','IN','TW']
...
datatemp.to_csv('/home/cathaylife04/smartphone/iphone11/static/data/Global_Mobility_Report.csv',encoding='utf_8_sig', index=False)
print('done')